...
func (ru *RoleUpdate) AddFeatureIDs(ids ...int) *RoleUpdate {
	ru.mutation.AddFeatureIDs(ids...)
	return ru
}

// AddFeature adds the "feature" edges to the Feature entity.
func (ru *RoleUpdate) AddFeature(f ...*Feature) *RoleUpdate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return ru.AddFeatureIDs(ids...)
}
...
func (ru *RoleUpdate) ClearFeature() *RoleUpdate {
	ru.mutation.ClearFeature()
	return ru
}

// RemoveFeatureIDs removes the "feature" edge to Feature entities by IDs.
func (ru *RoleUpdate) RemoveFeatureIDs(ids ...int) *RoleUpdate {
	ru.mutation.RemoveFeatureIDs(ids...)
	return ru
}

// RemoveFeature removes "feature" edges to Feature entities.
func (ru *RoleUpdate) RemoveFeature(f ...*Feature) *RoleUpdate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return ru.RemoveFeatureIDs(ids...)
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := ru.mutation.RemovedFeatureIDs(); len(nodes) > 0 && !ru.mutation.FeatureCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   role.FeatureTable,
	...
	if nodes := ru.mutation.FeatureIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   role.FeatureTable,
...
// AddFeatureIDs adds the "feature" edge to the Feature entity by IDs.
func (ruo *RoleUpdateOne) AddFeatureIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.AddFeatureIDs(ids...)
	return ruo
}

// AddFeature adds the "feature" edges to the Feature entity.
func (ruo *RoleUpdateOne) AddFeature(f ...*Feature) *RoleUpdateOne {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return ruo.AddFeatureIDs(ids...)
}
...
// ClearFeature clears all "feature" edges to the Feature entity.
func (ruo *RoleUpdateOne) ClearFeature() *RoleUpdateOne {
	ruo.mutation.ClearFeature()
	return ruo
}

// RemoveFeatureIDs removes the "feature" edge to Feature entities by IDs.
func (ruo *RoleUpdateOne) RemoveFeatureIDs(ids ...int) *RoleUpdateOne {
	ruo.mutation.RemoveFeatureIDs(ids...)
	return ruo
}

// RemoveFeature removes "feature" edges to Feature entities.
func (ruo *RoleUpdateOne) RemoveFeature(f ...*Feature) *RoleUpdateOne {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
	return ruo.RemoveFeatureIDs(ids...)
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if ruo.mutation.FeatureCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   role.FeatureTable,
	...
	if nodes := ruo.mutation.RemovedFeatureIDs(); len(nodes) > 0 && !ruo.mutation.FeatureCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   role.FeatureTable,
	...
	if nodes := ruo.mutation.FeatureIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   role.FeatureTable,
