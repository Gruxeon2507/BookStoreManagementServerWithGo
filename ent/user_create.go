...
func (uc *UserCreate) SetAvatarPath(s string) *UserCreate {
	uc.mutation.SetAvatarPath(s)
	return uc
}
...
func (uc *UserCreate) AddCreatedBy(b ...*Book) *UserCreate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.CreatedDate(); !ok {
		return &ValidationError{Name: "createdDate", err: errors.New(`ent: missing required field "User.createdDate"`)}
	}
	if _, ok := uc.mutation.AvatarPath(); !ok {
		return &ValidationError{Name: "avatarPath", err: errors.New(`ent: missing required field "User.avatarPath"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.AvatarPath(); ok {
