...
type UserEdges struct {
	...
	CreatedBy []*Book `json:"createdBy,omitempty"`
...
func (e UserEdges) CreatedByOrErr() ([]*Book, error) {
	if e.loadedTypes[0] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldPassword, user.FieldDisplayName, user.FieldEmail, user.FieldAvatarPath:
			values[i] = new(sql.NullString)
		case user.FieldDob, user.FieldCreatedDate:
...
func (u *User) QueryCreatedBy() *BookQuery {
...
func (u *User) String() string {
	...
	builder.WriteString(u.AvatarPath)
	builder.WriteByte(')')
